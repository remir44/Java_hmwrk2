...
public class program2 {
    ...
    private static String[][] jsonParseToArray(String jsnstr) {
    ...
    private static String[] glueingStrings(String[][] arraystr) {
        String[] glueing_str = new String[arraystr.length];
    ...
    public static void main(String[] args) {
        String strjsn_offile = getLineOffile("task2.json");
        // System.out.println(strjsn_offile);
        String[] array = glueingStrings(jsonParseToArray(strjsn_offile));
